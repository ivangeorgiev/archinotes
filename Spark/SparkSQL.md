...
object TableDDLBuilder {
     ...
     */
    def fromDF(df: DataFrame, tableName: String, dbName: String = "", fileLocation: String, format="ORC", partitionFields: List[String] = null): String = {
        val allFields = getFieldsFromDF( df )
        buildTableDDLFromFields( allFields = getFieldsFromDF( df ),
            tableName = tableName,
            dbName = dbName,
